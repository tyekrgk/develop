...
<!-- CSS begin -->
		...
		<!--[if lte IE 8]><link rel="stylesheet" type="text/css" href="css/sequencejs-theme.modern-slide-in.ie8.css" ><![endif]-->
		...
		<header id="header" >
			<div class="container clearfix">
				<div class="sixteen columns">
						<div class="header-container m-top-30 m-bot-50 clearfix">
									...
									<ul class="sf-menu clearfix">
										<li class="current"><a href="index.html">Home</a>
											<ul>
												...
												<li class="current"><a href="index3.html">Home 3</a></li>
		...
		<div class="sixteen columns">
			<div id="sequence-theme">
				...
				<div id="sequence">
					...
					<!-- SLIDE -->
						<li class="animate-in">
							<img class="bg-slide" src="images/bg-1-1.jpg" alt="bg 1" />

							<img class="model" src="images/model1-1.png" alt="Model 1" />
					...
					<!-- SLIDE -->	
						<li>
							<img class="bg-slide" src="images/bg-2-1.jpg" alt="bg 2" />

							<img class="model" src="images/model2-1.png" alt="Model 2" />
					...
					<!-- SLIDE -->	
						<li>
							<img class="bg-slide" src="images/bg-3-1.jpg" alt="bg 3" />

							<img class="model" src="images/model3-1.png" alt="Model 3" />
		...
		<!-- BLOCK -->
			<div class="block-4-col m-bot-20 ca-menu">
				<div class="block-1-content-container block-black">
					<a class=" clearfix" href="#item/solana-responsive-html5-template/5590059?ref=abcgomel">
						<div class="ca-icon">
		...
		<div class="sixteen columns">
			<div class="buy-container clearfix">
				...
				<div class="buy-text-container">
					<div class="buy-text">
						<h2>
							<span class="bold">Solana</span> is a Responsive Multipurpose Theme
						</h2>
				...
				<div class="button-buy-container">
					<a class="" href="#item/solana-responsive-html5-template/5590059?ref=abcgomel">PURCHASE IT</a>
				</div>
			</div>
		</div>
	</div>

    ...
    <div id="pd_add_form" class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">企业账号</label>
          <div class="col-sm-5">
            <input class="form-control valid" type="text" name="firmname" value="">
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input class="form-control valid" name="password" type="password">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input class="form-control valid" name="company_name" type="text">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input class="form-control valid" name="principal" type="text">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">负责人联系方式</label>
          <div class="col-sm-5">
            <input class="form-control valid" name="principal_phone" type="text">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input class="form-control valid" name="email" type="text">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input class="form-control valid" name="address" type="text">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        </div>
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-6">
            <button type="submit" class="btn btn-danger" id="buy_submit">确定注册</button>
          </div>
        </div>
      </div>
    </div>

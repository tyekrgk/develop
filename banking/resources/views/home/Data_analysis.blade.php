...
<div class="header fixed">
    <div class="w1200">
        ...
        <div class="nav">
            ...
            <a href="{{url('project/Data_analysis')}}" class="cur">财务分析</a>
	...
	<div class="content">
		...
		<div id="maincont"  data-fixedthead="true">   
			...
			<table class="m-table m-pager-table">
                ...
                <tbody>
					...
					<?php foreach ($add_list['data'] as $k => $v) {?>
                           ...
                           <tr>
                            <td>{{$v['analysis_id']}}</td>
                            <td><a href="">{{$v['analysis_code']}}</a></td>
                            <td><a href="">{{$v['analysis_abbreviation']}}</a></td>
                            <td class="c-fall">{{$v['analysis_Trailer']}}</td>
                            <td class="c-fall">{{$v['analysis_abstract']}}</td>
                            <td class="c-fall">{{$v['analysis_Range']}}</td>
                            <td>{{$v['analysis_profit']}}</td>
                            <td>{{$v['analysis_Date']}}</td>
            ...
            <a href="{{url('project/Data_analysis?page=1')}}">首页</a>
            <?php if($add_list['prev_page_url']==''){?>
            <a href="{{url('project/Data_analysis?page=1')}}">上一页</a>
            <?php }else{?>
            <a href="{{$add_list['prev_page_url']}}">上一页</a>
            <?php }?>

            <?php if($add_list['current_page']==1){?>
            <?php }else{?>
            <a href="{{url('project/Data_analysis?page=')}}{{$add_list['current_page']-1}}">{{$add_list['current_page']-1}}</a>
            <?php }?>

            <a href="{{url('project/Data_analysis?page=')}}{{$add_list['current_page']}}" style="color: red">{{$add_list['current_page']}}</a>
            ...
            <a href="{{url('project/Data_analysis?page=')}}{{$add_list['last_page']}}">下一页</a>
            <?php }else{?>
            <a href="{{$add_list['next_page_url']}}">下一页</a>
            <?php }?>
            <a href="{{url('project/Data_analysis?page=')}}{{$add_list['last_page']}}">尾页</a>

	...
	<div id="slider-container" class="container clearfix">
		<div class="sixteen columns ">
					<div class="flexslider">
						<ul class="slides">
							<li>
								<img src="images/sliders/slider-2/img-gallery.jpg" alt="image" />
							...
							<li>
								<img src="images/sliders/slider-2/img-gallery2.jpg" alt="image" />
								<div class="flex-caption">
							...
							<li>
								<img src="images/sliders/slider-2/img-gallery3.jpg" alt="image" />
								<div class="flex-caption">
		...
		<!-- BLOCK -->
			<div class="block-3-col  m-bot-35">
				<div class="block2-container content-container-white">
					<a class="block2-a clearfix" href="#item/solana-responsive-html5-template/5590059?ref=abcgomel">
...
<!-- JS begin -->
		...
		<script src="js/flex-slider2.js"></script> 
		<!-- end Flex Slider -->

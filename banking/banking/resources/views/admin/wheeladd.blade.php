  ...
  <form class="form-horizontal" action="{{url('/admin/wheeladdd')}}" method="post" enctype="multipart/form-data">
    <div id="pd_add_form" class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title">EP购买(<font color="red" size="24">本页面只允许使用谷歌浏览器</font>)</h3>
      </div>
      <div class="panel-body">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">排序</label>
          <div class="col-sm-5">
            <input class="form-control valid" type="text" value="" name="sort">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        </div>
        <div class="form-group">

...
<div class="dashboard-wrapper">
  ...
  <div class="table-responsive">
    <table class="table table-striped table-bordered td-center" id="data-lists">
      ...
      <tr>
        <td><span class="span" >{{ $p['type_id'] }}</span></td>
        <td>{{ $p['type_name'] }}</td>
        <td>{{ $p['type_center'] }}</td>
        <td>
          <a class="btn btn-warning" href="{{ URL('/admin/upda').'/'.$p['type_id'] }}">修改</a>  
          <a class="btn btn-danger del" data-id="<?=$p['type_id']?>">删除</a>
        </td>
      </tr>
      @endforeach
      </tbody>

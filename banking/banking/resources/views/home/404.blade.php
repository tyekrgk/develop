									...
									<ul class="sf-menu clearfix">
										...
										<li class="current"><a href="elements.html">Features</a>
											<ul>
												...
												<li class="current"><a href="404.html">404 Error</a></li>
	...
	<div class="container m-bot-35 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title"><span class="bold">OUPS!</span> NOT FOUND!</h1>
			</div>	
		</div>
	</div>	
	...
	<div class="container m-bot-100 m-top-80 clearfix">
		...
		<div class="eight columns ">
			...
			<div class="error404-text">
				THE PAGE<br> CANNOT<br> BE FOUND
			</div>
	...
	<div class="container clearfix pad-t-b-30">
		...
		<div class="sixteen columns content-container-white ">
				...
				<div class="error404-main-text">
					<h2><span class="bold">You can</span> view our <span class="bold"><a href="portfolio.html">portfolio</a></span>, or read the <span class="bold"><a href="blog.html">blog</a></span></h2>
				</div>
				...
				<div class="one-third column">
					...
					<div class="footer-social-links-container">	
						<ul class="social-links clearfix">
							...
							<li><a class="skype-link" target="_blank" title="Skype" href=""></a></li>
				...
				<div class="one-third column ">
					...
					<ul class="footer-contact-info">
						...
						<li class="footer-mail">
							<a href="">email@felius.com</a><br>
							<a href="">email@optimas.com</a>
						</li>
					</ul>
		...
		<div class="footer-copyright-bg">
			<div class="container ">
				<div class="sixteen columns clearfix">
					...
					&copy; Solan<span class="yellow">a</span> - Build with Passion by <a class="author" href="">AbcGomel</a>
					</div>
				</div>

...
<div class="header fixed">
    <div class="w1200">
        ...
        <div class="nav">
            ...
            <a href="{{url('project/money_liu')}}" class="cur">资金流向</a>
	...
	<div class="content">
		...
		<div id="maincont"  data-fixedthead="true">   
			...
			<table class="m-table m-pager-table">
                ...
                <tbody>
					...
					<?php foreach ($add_list['data'] as $k => $v) {?>
                           ...
                           <tr>
	                		<td>{{$v['moneyflow_id']}}</td>
	                		<td><a href="">{{$v['moneyflow_code']}}</a></td>
	                		<td><a href="">{{$v['moneyflow_abbreviation']}}</a></td>
	                		<td class="c-fall">{{$v['moneyflow_lateprice']}}</td>
	                		<td class="c-fall">{{$v['moneyflow_fluct']}}</td>
	                		<td class="c-fall">{{$v['moneyflow_rate']}}</td>
	                		<td>{{$v['moneyflow_funds']}}</td>
	                		<td>{{$v['moneyflow_outfunds']}}</td>
	                		<td>{{$v['moneyflow_net']}}</td>
	                		<td>{{$v['moneyflow_turnover']}}</td>
	                		<td>{{$v['moneyflow_inflow']}}</td>
            ...
            <a href="{{url('project/money_liu?page=1')}}">首页</a>
            <?php if($add_list['prev_page_url']==''){?>
            <a href="{{url('project/money_liu?page=1')}}">上一页</a>
            <?php }else{?>
            ...
            <?php }else{?>
            <a href="{{url('project/money_liu?page=')}}{{$add_list['current_page']-1}}">{{$add_list['current_page']-1}}</a>
            <?php }?>

            <a href="{{url('project/money_liu?page=')}}{{$add_list['current_page']}}" style="color: red">{{$add_list['current_page']}}</a>
            ...
            <a href="{{url('project/money_liu?page=')}}{{$add_list['last_page']}}">下一页</a>
            <?php }else{?>
            <a href="{{$add_list['next_page_url']}}">下一页</a>
            <?php }?>
            <a href="{{url('project/money_liu?page=')}}{{$add_list['last_page']}}">尾页</a>

	...
	<div class="main-wrap">
		<div class="w750 main-border">
			<div class="homepage-wrap">
				<center>
				<form action="<?php echo e(url('project/info')); ?>" method="post" enctype="multipart/form-data">
					<table>
						<tr>
							<td>
		<?php if($lists != ''): ?>
			<a href="javascript:void(0);" class="avatar por db"><img class="homepage-avatar" src="<?php echo e($lists['img_url']); ?>" alt=""></a>
		<?php else: ?>
			<a href="javascript:void(0);" class="avatar por db"><img class="homepage-avatar" src="<?php echo e(URL::asset('biu.jpg')); ?>" alt=""></a>
		<?php endif; ?>
							</td>
						</tr>
						<tr>
	...
	$(function(){
		$(".sub").blur(function(){
			...
			if(name1 != name){
				$.ajax({
					type:"get",
					url:"<?php echo e(url('project/ajax')); ?>",
					data:{"name":name},
					success:function(data){
						if(data==1){
							location.href=('<?php echo e(url("project/ge")); ?>');
						}else{
							location.href=('<?php echo e(url("project/ge")); ?>');
						}
					}
		...
		$(".text").blur(function(){
			...
			$.ajax({
				type:"get",
				url:"<?php echo e(url('project/center')); ?>",
				data:{"name":name},
				success:function(data){
					if(data==1){
						location.href=('<?php echo e(url("project/ge")); ?>');
			...
			window.getSelection().removeAllRanges();
				...
				<div class="homepage-self">
					...
					<div class="homepage-logic homepage-content">
						<span class="c444 hp-lg-content"><em id="selfInfo" class="wdwrap"><?php echo e($center); ?></em><a href="javascript:;" id="editInfo" class="icon-main icon-main-s-pen hp-lg-pos"></a></span>

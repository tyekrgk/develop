...
<div class="container w3layouts agileits">
	<!-- 成功提示框 -->
	<?php if(Session::has('hasSuccess')): ?>
	<div class="alert alert-success alert-dismissible" role="alert">
		<font color="red"><?php echo e(Session::get('hasSuccess')); ?></font>
	</div>
	<?php endif; ?>
	<!-- 失败提示框 -->
	<?php if(Session::has('hasExists')): ?>
	<div class="alert alert-danger alert-dismissible" role="alert">
		<font color="red"><strong>Error</strong> - <?php echo e(Session::get('hasExists')); ?></font>
	</div>
	<?php endif; ?>
	<form action="<?php echo e(url('project/registers')); ?>" method="post">

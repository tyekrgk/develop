  ...
  <div class="table-responsive">
    <table class="table table-striped table-bordered td-center" id="data-lists">
      ...
      <?php foreach($data as $v): ?>
        <tr>
          <th><?php echo e($v['master_id']); ?></th>
          <th><?php echo e($v['master_name']); ?></th>
          <th><?php echo e($v['master_suffer']); ?></th>
          <th><?php echo e($v['master_phone']); ?></th>
          <th><img style="width:120px;height:110px;" src="<?php echo e($v['master_url']); ?>"/></th>
          <th><?php echo e($v['master_prove']); ?></th>
          <th><?php echo e($v['master_email']); ?></th>
          <th>
            <?php if($v['master_jib'] == 1): ?>
              初级
            <?php elseif($v['master_jib'] == 2): ?>
              中级
            <?php elseif($v['master_jib'] == 3): ?>
              高级
            <?php endif; ?>
          </th>
          <th><img style="width:120px;height:110px;" src="<?php echo e($v['prove_url']); ?>" alt="" /></th>
          <th>
          <?php if($v['master_static'] == 0): ?>
            <a class="succ" style="cursor:pointer" data-id="<?php echo e($v['master_id']); ?>">是</a>
          <?php elseif($v['master_static'] == 1): ?>
            审核通过
            |&nbsp;&nbsp;
            <a style="cursor:pointer;" class="err" data-id="<?php echo e($v['master_id']); ?>">不想通过了</a>
          <?php endif; ?>
          </th>
        </tr>
      <?php endforeach; ?>
...
<script src="<?php echo e(URL::asset('jq.js')); ?>"></script>
<script>
  $(function(){
    $(".succ").click(function(){
      ...
      $.ajax({
        type:"get",
        url:"<?php echo e(url('admin/success')); ?>",
        data:{'id':name},
        success:function(data){
          if(data == 1){
            alert('审核通过')
            location.href=("<?php echo e(url('admin/wheel')); ?>");
          }
        }
      })
    })

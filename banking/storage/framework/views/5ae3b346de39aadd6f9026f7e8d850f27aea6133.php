...
<header>
  ...
  <div id="cssmenu" class="pull-left" style=""><div id="menu-button">Menu</div>
      ...
      <li class="" style="background:#1ab394">
          <a href="<?php echo e(url('admin/show')); ?>">
     ...
     <li class="has-sub"  style="background:#1ab394"><span class="submenu-button"></span>
          ...
          <ul>
             <li><a href="<?php echo e(url('admin/limits')); ?>">权限列表</a></li>
             <li><a href="<?php echo e(url('admin/limitsadd')); ?>">权限添加</a></li>
             <li><a href="<?php echo e(url('admin/adminshow')); ?>">管理员列表</a></li>
          </ul>
       </li>
        <li class="has-sub" style="background:#1ab394"><span class="submenu-button"></span>
          <a href="javascript:void(0);"><i class="fa fa-signal"></i>用户管理</a>
          <ul>
             <li><a href="<?php echo e(url('admin/user')); ?>">用户列表</a></li>
             <li><a href="<?php echo e(url('admin/useradd')); ?>">用户添加</a></li>
          </ul>
       </li>
        <li class="has-sub" style="background:#1ab394"><span class="submenu-button"></span>
          <a href="javascript:void(0);"><i class="fa fa-users"></i>企业管理</a>
          <ul>
             <li><a href="<?php echo e(url('admin/firm')); ?>">企业列表</a></li>
             <li><a href="<?php echo e(url('admin/firmadd')); ?>">企业添加</a></li>
          </ul>
        </li>
        <li class="active has-sub" style="background:#1ab394"><span class="submenu-button"></span>
          ...
          <ul>
             <li><a href="<?php echo e(url('admin/touck')); ?>">股票列表</a></li>
             <li><a href="<?php echo e(url('admin/touckadd')); ?>">股票添加</a></li>
          </ul>
        </li>
        <li class="has-sub" style="background:#1ab394"><span class="submenu-button"></span>
          <a href="javascript:void(0);"><i class="fa fa-bar-chart-o"></i>分类管理</a>
          <ul>
            <li><a href="<?php echo e(url('admin/type')); ?>">分类列表</a></li>
            <li><a href="<?php echo e(url('admin/typeadd')); ?>">分类添加</a></li>
          </ul>
        </li>
        <li class="has-sub" style="background:#1ab394"><span class="submenu-button"></span>
          <a href="javascript:void(0);"><i class="fa fa-comments"></i>轮播图管理</a>
          <ul>
             <li><a href="<?php echo e(url('admin/wheel')); ?>">轮播图列表</a></li>
             <li><a href="<?php echo e(url('admin/wheeladd')); ?>">轮播图添加</a></li>
          </ul>
        </li>
        <li class="has-sub" style="background:#1ab394"><span class="submenu-button"></span>
          <a href="javascript:void(0);"><i class="fa fa-fire"></i>日志管理</a>
          <ul>
             <li><a href="<?php echo e(url('admin/log')); ?>">日志列表</a></li>
          </ul>
        </li>
      </ul>
    </div> 
          ...
          <li>
            <div class="demo-btn-group clearfix">
              <button class="btn btn-danger">
                <a href="<?php echo e(url('/admin/loginout')); ?>">安全退出</a>
              </button>
            </div>
          </li>
        </ul>
...
<div class="dashboard-wrapper">
    ...
    <table class="table table-striped table-bordered td-center" id="data-lists">
      <thead>
       ...
       <?php foreach($data['data'] as $k=>$v){?>
        <tr class="have_price">
          <th class="price_zhi"><?php echo e($v['id']); ?></th>
          <th><?php echo e($v['cname']); ?></th>
          <th><?php echo e($v['category']); ?></th>
          <th><?php echo e($v['price']); ?></th>
          <th><?php echo e($v['diff']); ?></th>
          <th><?php echo e($v['chg']); ?></th>
          <th><?php echo e($v['preclose']); ?></th>
          <th><?php echo e($v['open']); ?></th>
          <th><?php echo e($v['high']); ?></th>
          <th><?php echo e($v['low']); ?></th>
          <th><?php echo e($v['amplitude']); ?></th>
          <th><?php echo e($v['volume']); ?></th>
          <th><?php echo e($v['mktcap']); ?></th>
          <th><?php echo e($v['market']); ?></th>
          <th><a href="{{URL('/admin/delete')">删除</a></th>
        </tr>
      <?php }?>
      </thead>
      <tbody>  
  ...
  <ul class="pagination no-margin pull-right">
      <li><a href="<?php echo e(url('admin/touck?page=1')); ?>" class="disabled">首页</a></li>
      <?php if($data['current_page']==1){?>
      <li><a href="<?php echo e(url('admin/touck?page=1')); ?>" class="disabled">上一页</a></li>
      <?php }else{?>
      <li><a href="<?php echo $data['prev_page_url']?>" class="disabled">上一页</a></li>
      <?php }?>

    <?php if($data['current_page']-1 < 1){?><?php }else{?>
    <li><a href="<?php echo e(url('admin/touck?page=')); ?><?php echo $data['current_page']-1?>"><?php echo $data['current_page']-1?></a></li>
    <?php }?>
    <li class="active"><a href="<?php echo e(url('admin/touck?page=')); ?><?php echo $data['current_page']?>"><?php echo $data['current_page']?></a></li>
    <?php if($data['current_page']+1 > $data['last_page']){?><?php }else{?>
    <li><a href="<?php echo e(url('admin/touck?page=')); ?><?php echo $data['current_page']+1?>"><?php echo $data['current_page']+1?></a></li>
    <?php }?>
    
    <?php if($data['current_page']==$data['last_page']){?>
    <li><a href="<?php echo e(url('admin/touck?page=')); ?><?php echo $data['current_page']?>" class="disabled">下一页</a></li>
    <?php }else{?>
    <li><a href="<?php echo $data['next_page_url']?>" class="disabled">下一页</a></li>
    <?php }?>
  <li><a href="<?php echo e(url('admin/touck?page=')); ?><?php echo $data['last_page']?>">尾页</a></li>
      </ul>

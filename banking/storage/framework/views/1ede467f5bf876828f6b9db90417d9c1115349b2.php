...
<div class="dashboard-wrapper">
      <form class="form-horizontal" action="<?php echo e(url('admin/allotint')); ?>" method="post">
      ...
      <div class="panel-body">
        <div class="form-group">
          ...
          <?php foreach($list as $k=>$v){?>
            ...
            <input type="checkbox" <?php foreach($data as $ke=>$va){?><?php if($v['authority_id']==$va['authority_id']){?>checked=""<?php }else{?><?php }?><?php }?> value="<?php echo $v['authority_id']?>" name="list[]">&nbsp;<?php echo e($v['authority_name']); ?>&nbsp;&nbsp;
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-6">
            <button type="submit" class="btn btn-danger" id="buy_submit">确定添加</button>
          </div>
        </div>
      </div>
    </div>

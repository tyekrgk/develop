...
<div class="dashboard-wrapper">
    ...
    <table class="table table-striped table-bordered td-center" id="data-lists">
      ...
      <?php foreach($data['data'] as $k=>$v){?>
        ...
        <tr>
          ...
          <th width="160px"><a href="<?php echo e(url('admin/limitsdel')); ?>?id=<?php echo $v['authority_id']?>">删除</a>&nbsp;|&nbsp;<a href="">修改</a></th>
        </tr>
  ...
  <ul class="pagination no-margin pull-right">
      <li><a href="<?php echo e(url('admin/limits?page=1')); ?>" class="disabled">首页</a></li>
    ...
    <?php for($i=1;$i<=$data['last_page'];$i++){?>
      ...
      <li>
      <?php }?>
    <a href="<?php echo e(url('admin/limits?page=')); ?><?php echo $i?>"><?php echo $i?></a></li>
    <?php }?>
    <li><a href="<?php echo $data['next_page_url']?>" class="disabled">下一页</a></li>
  <li><a href="<?php echo e(url('admin/limits?page=')); ?><?php echo $data['last_page']?>">尾页</a></li>
      </ul>

...
<div class="content">
        ...
        <div class="top_title2" style="margin-top: 104px">
            ...
            <p><?php echo e($data['name']); ?>（<?php echo e($data['gid']); ?>）</p>
        </div>
        <div class="mt30 clearfix">
            <div id="content">
                ...
                <h1>主要指标</h1>
                    <div id="zhibiao">
                        股本： <span><?php echo e($data['capital']); ?></span><br>
                        市值：   <span><?php echo e($data['markValue']); ?></span><br>
                        收益率： <span><?php echo e($data['ROR']); ?></span><br>
                        最新价： <span><?php echo e($data['lastestpri']); ?></span><br>
                        最高价： <span><?php echo e($data['maxpri']); ?></span><br>
                        最低价： <span><?php echo e($data['minpri']); ?></span><br>
                        涨跌额： <span><?php echo e($data['uppic']); ?></span><br>
                        涨跌幅%：<span><?php echo e($data['limit']); ?>%</span><br>
                        成交量：<span><?php echo e($data['traAmount']); ?></span><br>
                    </div>
                </div>
                <div id="info2">
                    <div class="info2-top">
                    ...
                    <div class="info2-centent">
                        <img src="<?php echo e($gopicture['minurl']); ?>" alt="">
                    </div>
                </div>
            </div>
            <div id="content2">
...
<script type="text/javascript">
    $(function(){
        $(".info2-top li").click(function(){
            ...
            var num = $(this).index();
            if(num==0){
                var url = "<?php echo e($gopicture['minurl']); ?>";
            }else if(num==1)
            {
                var url = "<?php echo e($gopicture['min_weekpic']); ?>"; 
            }else if(num==2)
            {
                var url = "<?php echo e($gopicture['dayurl']); ?>"; 
            }else if(num==3)
            {
                var url = "<?php echo e($gopicture['weekurl']); ?>"; 
            }else{
                var url = "<?php echo e($gopicture['monthurl']); ?>"; 
            }
        ...
        $('.brief li').click(function(){
            ...
            var num = $(this).index();
            if(num==0){
                var text = "<?php echo $info; ?>";
            }else if(num==1)
            {
                var text = '<table><?php echo $info2; ?></table>';
            }else if(num==2)
            {
                var text = ""; 
            }else if(num==3)

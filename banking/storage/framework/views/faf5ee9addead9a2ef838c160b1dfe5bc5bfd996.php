...
<div class="header fixed">
    <div class="w1200">
        ...
        <div class="nav">
            ...
            <a href="<?php echo e(url('project/Data_analysis')); ?>" class="cur">财务分析</a>
	...
	<div class="content">
		...
		<div id="maincont"  data-fixedthead="true">   
			...
			<table class="m-table m-pager-table">
				<thead>
					<tr>
						...
						<th style="width:22%"  class="cur"><a href="javascript:void(0)" field="zdf" order="desc"  class="desc">业绩预告摘要<i></i></a></th>
                ...
                <tbody>
					...
					<?php foreach ($add_list['data'] as $k => $v) {?>
                           ...
                           <tr>
                            <td><?php echo e($v['analysis_id']); ?></td>
                            <td><a href=""><?php echo e($v['analysis_code']); ?></a></td>
                            <td><a href=""><?php echo e($v['analysis_abbreviation']); ?></a></td>
                            <td class="c-fall"><?php echo e($v['analysis_Trailer']); ?></td>
                            <td class="c-fall"><?php echo e($v['analysis_abstract']); ?></td>
                            <td class="c-fall"><?php echo e($v['analysis_Range']); ?></td>
                            <td><?php echo e($v['analysis_profit']); ?></td>
                            <td><?php echo e($v['analysis_Date']); ?></td>
            ...
            <a href="<?php echo e(url('project/Data_analysis?page=1')); ?>">首页</a>
            <?php if($add_list['prev_page_url']==''){?>
            <a href="<?php echo e(url('project/Data_analysis?page=1')); ?>">上一页</a>
            <?php }else{?>
            ...
            <?php }else{?>
            <a href="<?php echo e(url('project/Data_analysis?page=')); ?><?php echo e($add_list['current_page']-1); ?>"><?php echo e($add_list['current_page']-1); ?></a>
            <?php }?>

            <a href="<?php echo e(url('project/Data_analysis?page=')); ?><?php echo e($add_list['current_page']); ?>" style="color: red"><?php echo e($add_list['current_page']); ?></a>
            ...
            <a href="<?php echo e(url('project/Data_analysis?page=')); ?><?php echo e($add_list['last_page']); ?>">下一页</a>
            <?php }else{?>
            <a href="<?php echo e($add_list['next_page_url']); ?>">下一页</a>
            <?php }?>
            <a href="<?php echo e(url('project/Data_analysis?page=')); ?><?php echo e($add_list['last_page']); ?>">尾页</a>

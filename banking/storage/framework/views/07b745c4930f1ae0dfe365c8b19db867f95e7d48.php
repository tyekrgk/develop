...
<div class="header fixed">
    <div class="w1200">
        ...
        <div class="nav">
            ...
            <a href="<?php echo e(url('project/master')); ?>" class="cur">炒股大师</a>
        </div>
        <?php if($name != ''): ?>
    ...
    <div class="content">
        <br>
        <div class="qwe" style="width:80%;height: 380px;border: 0px solid red;margin-left: 10% ">
            <div style="float: left;width:20%;height: 280px;border: 0px solid red;">
                ...
                <?php if($list!=''){?>
                    ...
                    <? }else{?>
                    <span class="dzan" style="color:red;cursor: pointer;" masterid="<?php echo e($data[0]['master_id']); ?>">点赞</span>
                    <? }?>
                <?php }else{?>
                    <span class="dzan" style="color:red;cursor: pointer;" masterid="<?php echo e($data[0]['master_id']); ?>">点赞</span>
                <?php }?>
                ...
                <?php if($show!=''){?>
                    <? if(in_array($data[0]['master_id'],$show)){?>
                        <span style="color:red;cursor: pointer;" class="jguan" master="<?php echo e($data[0]['master_id']); ?>">已关注</span>
                    <? }else{?>
                    <sapn class="jguan" style="color:red;cursor: pointer;" master="<?php echo e($data[0]['master_id']); ?>">加关注</sapn>
                    <? }?>
                <?php }else{?>
                    <sapn class="jguan" style="color:red;cursor: pointer;" master="<?php echo e($data[0]['master_id']); ?>">加关注</sapn>
                <?php }?>
        ...
        <br>
        <div class="asd" style="width:80%;height: 800px;border: 1px solid red;margin-left: 10% ">
            <div style="border: 1px solid red;width: 75%;height: 100%">
                <div style="border: 0px solid red;width: 100%;height: 40px;background: ">
                    <span style="font-size: 28px; font-family:'楷体'; font-style:italic;">发布的文章:</span>
                </div>
            </div>
        </div> 
        <br>
...
<script>
    $('.dzan').click(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo e(url('project/dianz')); ?>",
            data:{'m_id':m_id},
            success:function(mas){
                ...
                if(mas==1){
                    alert('点赞成功');
                    window.location.href = "<?php echo e(url('project/masterlist')); ?>?id="+m_id;
                }
                if(mas==2){
                    alert('点赞失败');
                }
    ...
    $('.jguan').click(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo e(url('project/guan')); ?>",
            data:{'m_id':m_id},
            success:function(mas){
                if(mas==0){
                    alert('请先登录');

...
<div class="dashboard-wrapper">
      <form class="form-horizontal" action="<?php echo e(url('admin/limitsin')); ?>" method="post">
    <div id="pd_add_form" class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input class="form-control valid" type="text" value="" name="colename">
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input class="form-control valid" type="text" name="coleurl">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        </div>
        <div class="form-group">

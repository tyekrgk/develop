        ...
        <div class="qwe" style="width:80%;height: 280px;border: 0px solid red;margin-left: 10% ">
            <div style="float: left;width:20%;height: 280px;border: 0px solid red;">
                ...
                <?php if($list!=''){?>
                    ...
                    <? }else{?>
                    <span class="dzan" style="color:red;cursor: pointer;" masterid="<?php echo e($v['master_id']); ?>">点赞</span>
                    <? }?>
                <?php }else{?>
                    <span class="dzan" style="color:red;cursor: pointer;" masterid="<?php echo e($v['master_id']); ?>">点赞</span>
                <?php }?>
                ...
                <?php if($show!=''){?>
                    <? if(in_array($v['master_id'],$show)){?>
                        <span style="color:red;cursor: pointer;" class="jguan" master="<?php echo e($v['master_id']); ?>">已关注</span>
                    <? }else{?>
                    <sapn class="jguan" style="color:red;cursor: pointer;" master="<?php echo e($v['master_id']); ?>">加关注</sapn>
                    <? }?>
                <?php }else{?>
                    <sapn class="jguan" style="color:red;cursor: pointer;" master="<?php echo e($v['master_id']); ?>">加关注</sapn>
                <?php }?>
            ...
            <a href="<?php echo e(url('project/mastershow')); ?>?id=<?php echo e($v['master_id']); ?>"><div style="float:right;width:70px;height:35px;border: 0px solid red;margin-right:6%;background: #ccc;text-align: center;cursor: pointer;">
    ...
    $('.dzan').click(function(){
        ...
        $.ajax({
            ...
            success:function(mas){
                ...
                if(mas==1){
                    alert('点赞成功');
                    window.location.href = "<?php echo e(url('project/master')); ?>";
                }
                if(mas==2){
                    alert('点赞失败');
                }

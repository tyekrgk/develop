...
<div class="mar m-pager-box1" board="all">
           ...
           <div class="mt30 clearfix">
                <div class="data-line" style="margin-bottom: 15px;">
                    ...
                    <br>
                    <center>
                    <span class="red" style="font-size:28px;"><?php echo $title; ?></span>
                    <br>
                    <br>
                    <span><?php echo $time; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span>来源：<?php echo $source; ?></span><br><br><hr>
                    </center>
...
<!-- <p>
<a href="<?php echo e(url('project/show')); ?>" >首页</a> > <a href="<?php echo e(url('project/meigu')); ?>" >美股频道</a> > <a href="" >美股新闻</a> > 正文
</p> -->
</div>
<!-- <div class="titmain">
    ...
    <p class="inftop">
        ...
        <span>来源：<?php echo e($source); ?></span>
    </p>

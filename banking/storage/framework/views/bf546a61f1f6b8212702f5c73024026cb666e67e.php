...
<base href="<?php echo e(URL::asset('Home/personal').'/'); ?>">
...
<div class="header">
    <div class="control">
        ...
        <div class="hd_right fr">
            <a class="art-collect" href="<?php echo e(url('project/show')); ?>">返回首页</a>
            <?php if($name != ''): ?>
...
<div class="info_panel day" style="background: url(&quot;http://s.thsi.cn/css/ucenter/website/images/back.png&quot;) center center no-repeat;">
    <div class="control">
        <h1 class="person_pic"><a href="<?php echo e(url('project/ge')); ?>"><img src="<?php echo e($lists['img_url']); ?>" alt=""></a><span id="page-title"><?php echo e($name); ?></span></h1>
        <div class="infos">
            <div class="sible">
...
<div class="lay_out control">
    ...
    <li class="nav-btn pconcern" data-id="focus" data-title="我的名家"><a href="<?php echo e(url('project/mjia')); ?>">我的名家</a></li>
    <li class="nav-btn receive" data-id="collection" data-title="我的收藏"><a href="#">我的收藏</a></li>
    <li class="nav-btn hqcenter" data-id="collection" data-title="申请大师"><a href="<?php echo e(url('project/Apply')); ?>">申请大师</a></li>
    <?php if(empty($data)){?>
    <?php }else{?>
    <li class="nav-btn hqcenter" data-id="collection" data-title="发布文章"><a href="<?php echo e(url('project/issue')); ?>">发布文章</a></li>
    <?php }?>
</ul>
<script>
...
if (!active) {
    ...
    $('#page-title').html('<?php echo e($name); ?>');
}
</script>
<hr>
...
<!--                 6000.00万 -->
            ...
            <table class="fr operate">
                ...
                <?php foreach($ppo as $v): ?>
                    <tr class="">
                        <td></td>
                        <td class="operate"><i class="rmv" data-id="<?php echo e($v['id']); ?>"></i></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
    ...
    $(function(){
        $(".rmv").click(function(){
            ...
            if(confirm("确定要删除吗？")){
                $.ajax({
                    type:"get",
                    url:"<?php echo e(url('project/del')); ?>",
                    data:{"id":id},
                    success:function(data){
                        if(data == 1){
                            location.href=("<?php echo e(url('project/personal')); ?>");
                        }else{
                            location.href=("<?php echo e(url('project/personal')); ?>");
                        }
                    }

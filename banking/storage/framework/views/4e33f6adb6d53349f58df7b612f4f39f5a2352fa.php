...
<div class="header fixed">
    <div class="w1200">
        ...
        <div class="nav">
            ...
            <a href="<?php echo e(url('project/money_liu')); ?>">财务分析</a>
            <a href="<?php echo e(url('project/Data_analysis')); ?>">资金流向</a>
    ...
    <div class="content">
        ...
        <div class="mt30 clearfix">
          <input type='hidden' class="xin" value="<?php echo e($add_list); ?>">
            ...
            <div class="all_maincont">               
                <table class="m-table m-pager-table">
                    ...
                    <?php foreach($data as $k=>$v){?>
                        ...
                        <tr style="color:red">
                        <?php }?>
                            <td><a href="<?php echo e(url('project/meigu_info')); ?>/<?php echo e($v['symbol']); ?>"><?php echo $v['cname']?></a></td>
...
<script>
    $(function(){
        $(".j_addStock").click(function(){
            ...
            $.ajax({
                type:"get",
                url:"<?php echo e(url('project/zixuan')); ?>",
                data:{'name':name},
            ...
            <div class="cf">
                ...
                <div class="top_title2">
                    <div class="left_border"></div>
                    <p>美股要闻</p><span class="more"><a href="<?php echo e(url('project/meigu_newpage')); ?>?type=mgyw" target="_blank">更多&gt;&gt;</a></span>
                </div>
                <ul>
                    <?php foreach($yw as $v): ?>
                    <li>
                        <a href="<?php echo e(url('project/meigu_new')); ?>?link=<?php echo e($v['link']); ?>&type=mgyw" target="_blank" title="<?php echo e($v['title']); ?>">
                            <?php if(mb_strlen($v['title'])>17): ?>
                                <?php echo e(mb_substr($v['title'],0,17).'...'); ?>

                            <?php else: ?>
                                <?php echo e($v['title']); ?>

                            <?php endif; ?>
                        </a><span class="right_date"><?php echo e($v['time']); ?></span>
                    </li>
                    <?php endforeach; ?>         
                </ul>
            </div>
            ...
            <div class="news_l ">
                <div class="top_title2">
                    <div class="left_border"></div>
                    <p>中概股新闻</p><span class="more"><a href="<?php echo e(url('project/meigu_newpage')); ?>?type=zggng" target="_blank">更多&gt;&gt;</a></span>
                </div>
                <ul>
                    <?php foreach($gng as $v): ?>
                    <li>
                        <a href="<?php echo e(url('project/meigu_new')); ?>?link=<?php echo e($v['link']); ?>&type=zggng" target="_blank" title="<?php echo e($v['title']); ?>">
                            <?php if(mb_strlen($v['title'])>17): ?>
                                <?php echo e(mb_substr($v['title'],0,17).'...'); ?>
            ...
            <div class="news_l no_r">
                <div class="top_title2">
                    <div class="left_border"></div>
                    <p>研究分析</p><span class="more"><a href="<?php echo e(url('project/meigu_newpage')); ?>?type=yjfx" target="_blank">更多&gt;&gt;</a></span>
                </div>
                <ul>
                    <?php foreach($yjfx as $v): ?>
                    <li>
                        <a href="<?php echo e(url('project/meigu_new')); ?>?link=<?php echo e($v['link']); ?>&type=yjfx" target="_blank" title="<?php echo e($v['title']); ?>">
                            <?php if(mb_strlen($v['title'])>17): ?>
                                <?php echo e(mb_substr($v['title'],0,17).'...'); ?>
